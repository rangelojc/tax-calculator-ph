...
import {
  Checkbox, LABEL_PLACEMENT, STYLE_TYPE
} from "baseui/checkbox";
import { FlexGrid, FlexGridItem } from 'baseui/flex-grid';
import { FormControl } from "baseui/form-control";
import { Input } from "baseui/input";
import { ALIGN, Radio, RadioGroup } from "baseui/radio";
import { LabelLarge, LabelXSmall, ParagraphMedium, ParagraphSmall } from 'baseui/typography';
...
const InfoLink: React.FC<{ link: string, linkLabel: string }> = (props) => {
  return (<ParagraphSmall>
    <Block display={['flex']} flexDirection={['column', 'column', 'row']} gridGap={['0', '0', '3px']}>
      <span>{props.children}:</span>
      <a href={props.link} target={'_blank'} rel='noreferrer'>{props.linkLabel}</a>
    </Block>
...
function App() {
  ...
  const [summary, setSummary] = useState<ITaxSummary>({
    gross: 0, taxable: 0, nonTaxable: 0, taxDue: 0, takeHome: 0, totalContribution: 0
  })
  ...
  useEffect(() => {
    ...
    setSummary({ ...taxable, taxDue: computeTaxDue(taxable.taxable, use2023 ? '2023' : '2018'), takeHome: 0 })
    ...
    <StyletronProvider value={engine}>
      <BaseProvider theme={LightTheme}>
            ...
            >
              ...
              >
                ...
                <Panel style={
                  ...
                  <ParagraphSmall>
                    Good <a href='https://www.taxumo.com/blog/withholding-tax-101-or-why-is-my-pay-less-than-what-my-client-said-it-would-be/'>article</a> about Withholding tax vs Income tax.
                  </ParagraphSmall>

                </Panel>
                {showAdvanced && <Panel style={
                  {
                    marginTop: theme.sizing.scale800,
                    backgroundColor: theme.colors.backgroundSecondary,
                    padding: theme.sizing.scale800
                  ...
                  <ParagraphSmall>
                    On January 1, 2023 the tax rates will change to something <b>lower</b> according to <a href='https://www.officialgazette.gov.ph/downloads/2017/12dec/20171219-RA-10963-RRD.pdf'>RA 10963</a>, toggle the switch below to preview your tax rates then.
                  </ParagraphSmall>
                ...
                <Block display={'flex'} flexDirection={'row-reverse'} marginTop={theme.sizing.scale200}>
                  <LabelXSmall
                    onClick={() => {
                      setShowAdvanced(q => !q)
                    }}
                  ...
                  >{showAdvanced ? 'Hide' : 'Show'} Advanced options</LabelXSmall>
                </Block>
        ...
        <Block
          ...
          flexDirection={'column'} alignItems={'center'} justifyContent={'center'} display={'flex'}>
          <ParagraphMedium>Found this useful?</ParagraphMedium>
          <a href="https://www.buymeacoffee.com/exkpSj2"><img alt='Buy me coffee' src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=exkpSj2&button_colour=FFDD00&font_colour=000000&font_family=Bree&outline_colour=000000&coffee_colour=ffffff" /></a>
        </Block>
      </BaseProvider>
    </StyletronProvider>
  );
